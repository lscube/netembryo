/*
  ...
  $Id:rtcp-packet.c 3 2005-12-06 10:40:45Z federico $
*/
...
#include <programs/rtcp-packet.h>
...
/*chicco*/
Rtcp_Compound
rtcp_compound_read(Sock *fromaddr, int nbytes)
{
  int packlen;
  gpointer buf;
...
/*chicco*/
void
rtcp_compound_send(Rtcp_Compound compound, Sock *toaddr, int nbytes)
{
  g_return_if_fail(compound != NULL);

//  sendto(fd, (void *) compound -> data,compound -> data_len, 0,toaddr, tolen);
	Sock_write(toaddr, (void *) compound -> data, nbytes);
}
